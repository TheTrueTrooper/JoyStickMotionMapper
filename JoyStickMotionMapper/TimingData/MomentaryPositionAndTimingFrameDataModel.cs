...
namespace JoyStickMotionMapper.TimingData
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Adds the two values. note: for states it takes the left state as it is assumed you are just adding the postions for a new vector of sorts.
        /// </summary>
        /// <param name="Left"></param>
        /// <param name="Right"></param>
        /// <returns></returns>
        public static MomentaryPositionAndTimingFrameDataModel operator +(MomentaryPositionAndTimingFrameDataModel Left, MomentaryPositionAndTimingFrameDataModel Right)
        {
            return new MomentaryPositionAndTimingFrameDataModel
            {
                Time = Left.Time + Right.Time,
                C1 = (byte)(Left.C1 + Right.C1),
                C2 = (byte)(Left.C1 + Right.C1),
                C3 = (byte)(Left.C1 + Right.C1),
                C4 = (byte)(Left.C1 + Right.C1),
                C5 = (byte)(Left.C1 + Right.C1),
                C6 = (byte)(Left.C1 + Right.C1),
                Snowflakes = Left.Snowflakes,
                SweepingLegs1 = Left.SweepingLegs1,
                Wind = Left.Wind,
                Rain = Left.Rain,
                Smoke = Left.Smoke,
                Bubbles = Left.Bubbles,
                Lightning = Left.Lightning,
                Flame = Left.Flame,
                Jet = Left.Jet,
                SweepingLegs2 = Left.SweepingLegs2,
                WaterSpray = Left.WaterSpray,
                Vibration = Left.Vibration,
                Back = Left.Back,
                Spare1 = Left.Spare1,
                Spare2 = Left.Spare2,
                Spare3 = Left.Spare3
        ...
        /// <summary>
        /// Subtracts the two values. note: for states it takes the left state as it is assumed you are just subtracting the postions for a new vector of sorts.
        /// </summary>
        /// <param name="Left"></param>
        /// <param name="Right"></param>
        /// <returns></returns>
