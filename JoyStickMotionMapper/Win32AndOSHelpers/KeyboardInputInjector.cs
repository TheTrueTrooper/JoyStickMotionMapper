...
namespace JoyStickMotionMapper.Win32AndOSHelpers
{
    public static class KeyboardInputInjector
    {
        public static void SendKeyboardInputStroke(ScanCodeShort a, bool Shift = false)
        {
            if (Shift)
            {
                LShiftDown();
        ...
        public static void KeyDownRaw(ScanCodeShort a)
        {
        ...
        public static void KeyUpRaw(ScanCodeShort a)
        {
            INPUT[] Inputs = new INPUT[1];
            INPUT Input = new INPUT();
            Input.type = 1; // 1 = Keyboard Input
